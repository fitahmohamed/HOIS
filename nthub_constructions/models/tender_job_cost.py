...
class TenderJobCosting(models.Model):
    ...
    subcontractor_total = fields.Float(string=_('Total Subcontractor'), compute='_compute_subcontractor_total',
                                       store=True)
    jobcost_total = fields.Float(string=_('Total Price'), compute='_compute_jobcost_total', store=True)
